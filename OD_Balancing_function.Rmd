...
read_excel_sheets <- function(file){
  ...
  x <- lapply(x, function(y) {row.names(y) <-  y[,1]; y[,-1]})
  names(x) <- sheets
  return(x)
}
...
all(lapply(c(1:length(vol_1)), function(x) all(as.numeric(row.names(percent_1)) == vol_1[[x]]$Node)))
  
all(lapply(c(1:length(vol_1)), function(x) all(as.numeric(colnames(percent_1)) == tar_1[[x]]$Node)))
...
all(lapply(c(1:length(vol_2)), function(x) all(as.numeric(row.names(percent_2)) == vol_2[[x]]$Node)))
  
all(lapply(c(1:length(vol_2)), function(x) all(as.numeric(colnames(percent_2)) == tar_2[[x]]$Node)))
...
all(lapply(c(1:length(vol_3)), function(x) all(as.numeric(row.names(percent_3)) == vol_3[[x]]$Node)))
  
all(lapply(c(1:length(vol_3)), function(x) all(as.numeric(colnames(percent_3)) == tar_3[[x]]$Node)))
...
all(lapply(c(1:length(vol_4)), function(x) all(as.numeric(row.names(percent_4)) == vol_4[[x]]$Node)))
  
all(lapply(c(1:length(vol_4)), function(x) all(as.numeric(colnames(percent_4)) == tar_4[[x]]$Node)))
...
all(lapply(c(1:length(vol_5)), function(x) all(as.numeric(row.names(percent_5)) == vol_5[[x]]$Node)))
  
all(lapply(c(1:length(vol_5)), function(x) all(as.numeric(colnames(percent_5)) == tar_5[[x]]$Node)))
...
all(lapply(c(1:length(vol_6)), function(x) all(as.numeric(row.names(percent_6)) == vol_6[[x]]$Node)))
  
all(lapply(c(1:length(vol_6)), function(x) all(as.numeric(colnames(percent_6)) == tar_6[[x]]$Node)))
...
all(lapply(c(1:length(vol_7)), function(x) all(as.numeric(row.names(percent_7)) == vol_7[[x]]$Node)))
  
all(lapply(c(1:length(vol_7)), function(x) all(as.numeric(colnames(percent_7)) == tar_7[[x]]$Node)))
...
all(lapply(c(1:length(vol_8)), function(x) all(as.numeric(row.names(percent_8)) == vol_8[[x]]$Node)))
  
all(lapply(c(1:length(vol_8)), function(x) all(as.numeric(colnames(percent_8)) == tar_8[[x]]$Node)))
...
all(lapply(c(1:length(vol_9)), function(x) all(as.numeric(row.names(percent_9)) == vol_9[[x]]$Node)))
  
all(lapply(c(1:length(vol_9)), function(x) all(as.numeric(colnames(percent_9)) == tar_9[[x]]$Node)))
...
all(lapply(c(1:length(vol_10)), function(x) all(as.numeric(row.names(percent_10)) == vol_10[[x]]$Node)))
  
all(lapply(c(1:length(vol_10)), function(x) all(as.numeric(colnames(percent_10)) == tar_10[[x]]$Node)))
...
all(lapply(c(1:length(vol_11)), function(x) all(as.numeric(row.names(percent_11)) == vol_11[[x]]$Node)))
  
all(lapply(c(1:length(vol_11)), function(x) all(as.numeric(colnames(percent_11)) == tar_11[[x]]$Node)))
