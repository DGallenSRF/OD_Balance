...
all(sapply(c(1:length(vol_1)), function(x) all(as.numeric(colnames(percent_1)) == tar_1[[x]]$Node)))
...
all(sapply(c(1:length(vol_3)), function(x) all(as.numeric(row.names(percent_3)) == vol_3[[x]]$Node)))
  
all(sapply(c(1:length(vol_3)), function(x) all(as.numeric(colnames(percent_3)) == tar_3[[x]]$Node)))
...
all(sapply(c(1:length(vol_6)), function(x) all(as.numeric(row.names(percent_6)) == vol_6[[x]]$Node)))
